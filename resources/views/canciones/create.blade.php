...
<div class="container">
  <div class="card">
    <div class="card-header">
      <h2>{{ __('global.add') }} {{ __('cruds.cancion.title_singular') }}</h2>
    </div>
    <div class="card-body">
      <form action="{{ route("canciones.store") }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <textarea id="letra" name="letra" class="form-control" rows="5" tabindex="2"></textarea>
        </div>
        <div class="mb-3">
          <label for="mp3" class="form-label">{{ __('cruds.cancion.fields.mp3') }}</label>
          <input id="mp3" name="mp3" type="number" step="any" class="form-control" tabindex="3" min="0" max="1" value="0">
        </div>
        <div class="mb-3">
